...
import com.intuit.cg.backendtechassessment.users.repository.SellerRepository;
...
import static com.intuit.cg.backendtechassessment.configuration.requestmappings.RequestMappings.SELLERS;
...
class SellerController extends ResourceController {
	...
	List<Project> getProjects(@PathVariable Long id) {
